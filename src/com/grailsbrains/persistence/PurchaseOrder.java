...
public class PurchaseOrder implements Comparable<PurchaseOrder> {
    ...
    public int compareTo(PurchaseOrder o) {
        int comparePoNumber = (o).getPoNumber();

        //ascending order
        return this.poNumber- comparePoNumber;
    }

    public static Comparator<PurchaseOrder> SupplierComparator = new Comparator<PurchaseOrder>() {

        public int compare(PurchaseOrder po1, PurchaseOrder po2) {

            String seller_vendor1 = po1.getSeller_vendor().toUpperCase();
            String seller_vendor2 = po2.getSeller_vendor().toUpperCase();

            //ascending order
            return seller_vendor1.compareTo(seller_vendor2);
